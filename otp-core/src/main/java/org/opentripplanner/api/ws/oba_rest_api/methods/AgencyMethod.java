...
import org.opentripplanner.api.ws.oba_rest_api.beans.TransitAgency;
...
/**
 * Implements the <a href="http://developer.onebusaway.org/modules/onebusaway-application-modules/current/api/where/methods/agency.html">agency</a> OneBusAway API method.
 * <br />
 * <a href="http://localhost:8888/bkk-utvonaltervezo-api/ws/otp/api/where/agency/BKK.json">/otp/api/where/agency/BKK.json</a>
 */

@Path(OneBusAwayApiMethod.API_BASE_PATH + "agency/{agencyId}" + OneBusAwayApiMethod.API_CONTENT_TYPE)
public class AgencyMethod extends OneBusAwayApiMethod<TransitEntryWithReferences<TransitAgency>> {
